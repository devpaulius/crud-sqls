...
module.exports = {
  ...
  find: id => prisma.user.findUnique({
    ...
    select:{
      ...
      public_profile:true,blocked:true,is_admin:true
    }
  }),
  ...
  updateProfile: (id,data) =>
    prisma.user.update({ where:{ id:Number(id) }, data: pick(data,PROFILE_FIELDS) }),
  ...
  updateSettings:(id,data) =>
    prisma.user.update({ where:{ id:Number(id) }, data: pick(data,SETTINGS_FIELDS) }),
};